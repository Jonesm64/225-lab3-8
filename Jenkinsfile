pipeline {
    ...
    environment {
        ...
        GITHUB_URL = 'https://github.com/jonesm64/225-lab3-8.git'  // GitHub repository containing Kubernetes YAML files
        KUBECONFIG = credentials('jonesm64-225-sp26')             // Jenkins stored credential for accessing your Kubernetes cluster
    }
